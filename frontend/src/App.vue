...
import { ArrowLeft, ArrowRight, Bell, ChatDotRound, ChatLineRound, Close, CollectionTag, CopyDocument, DataAnalysis, Delete, Document, Download, Edit, EditPen, Files, House, Loading, MagicStick, Menu, Message, MoreFilled, Notebook, Plus, Promotion, Reading, Refresh, Search, Setting, Star, SwitchButton, Tickets, Upload, UploadFilled, User, UserFilled, View, Warning } from '@element-plus/icons-vue';
...
const aiConfig = ref({ platform_name:'知汇', platform_notice:'', registration_enabled:true, ai_chat_enabled:true, knowledge_upload_enabled:true, user_ranking_enabled:true, community_enabled:true, comments_enabled:true, private_messages_enabled:true, notifications_enabled:true, feedback_enabled:true, post_audit_required:true, profile_audit_required:false, default_publish_policy:'STANDARD', max_upload_mb:25, max_post_images:9, max_comment_length:2000, max_message_length:2000, draft_retention_days:30, data_source_scope:'all-approved', match_limit:5, compliance_rule:'answer-with-references', provider:'local', model:'local-rag', base_url:'', request_url:'', temperature:0.2, selected_file_ids:[] as number[] });
...
const platformConfig = ref({ platform_name:'知汇', platform_notice:'', registration_enabled:true, ai_chat_enabled:true, knowledge_upload_enabled:true, user_ranking_enabled:true, community_enabled:true, comments_enabled:true, private_messages_enabled:true, notifications_enabled:true, feedback_enabled:true, post_audit_required:true, profile_audit_required:false, default_publish_policy:'STANDARD', max_upload_mb:25, max_post_images:9, max_comment_length:2000, max_message_length:2000, draft_retention_days:30 });
