      ...
      <main class="content-area">
        ...
        <template v-else>
          ...
          <section v-else-if="activeView === 'moderation'" class="page-stack">
            <div class="page-toolbar"><div><h3>内容审核</h3><p>先查看完整内容，再处理知识、帖子和举报</p></div><el-button :icon="Refresh" @click="loadModeration">刷新队列</el-button></div>
...
async function uploadKnowledge(){
  ...
  try{
    ...
    await loadKnowledge();ElMessage.success('资料已保存并完成正文索引，等待管理员审核');
